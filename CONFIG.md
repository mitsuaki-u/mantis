...
- `HONEYBADGER_SCAN_INTERVAL` - Market scan interval in seconds
...
- `HONEYBADGER_STRATEGY_THRESHOLD` - Signal threshold
...
fn my_function() -> Result<()> {
    ...
    let scan_interval = config.trading.scan_interval;
